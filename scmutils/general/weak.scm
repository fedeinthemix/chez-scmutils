...
;;; FBE
;; We use fake weak pairs because we do not have a generaic weak
...
(define (list->weak-list l) l)
(define weak-set-cdr! set-cdr!)

;;; Use Chez Scheme weak pairs

;; ;;(define weak-pair? pair?)
;; ;;(define weak-cons cons)
;; (define weak-car car)
;; (define weak-cdr cdr)
;; (define (weak-pair/car? p)
;;   (bwp-object? (car p)))
;; ;; from MIT-Scheme
...
;;; FBE: from general/canonicalizer.scm which is not loaded??
