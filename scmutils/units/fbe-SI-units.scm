...
(define-derived-unit SI '&newton
  "N" "force" (g:/ (g:* &kilogram &meter) (g:square &second)))

(define-derived-unit SI '&joule
  "J" "energy" (g:* &newton &meter))


(define-derived-unit SI '&coulomb
  "C" "electric charge" (g:* &ampere &second))


(define-derived-unit SI '&watt
  "W" "power" (g:/ &joule &second))

(define-derived-unit SI '&volt
  "V" "electric potential" (g:/ &watt &ampere))

;;; FBE need to escape backslash: \Omega -> \\Omega
(define-derived-unit SI '&ohm
  ;; "\Omega" "electric resistance" (/ &volt &ampere))
  "\\Omega" "electric resistance" (g:/ &volt &ampere))

(define-derived-unit SI '&siemens
  "S" "electric conductance" (g:/ &unitless &ohm))

(define-derived-unit SI '&farad
  "F" "capacitance" (g:/ &coulomb &volt))


(define-derived-unit SI '&weber
  "Wb" "magnetic flux" (g:* &volt &second))

(define-derived-unit SI '&henry
  "H" "inductance" (g:/ &weber &ampere))

(define-derived-unit SI '&hertz
  "Hz" "frequency" (g:/ &unitless &second) :2pi)

(define-derived-unit SI '&tesla
  "T" "magnetic flux density" (g:/ &weber (g:square &meter)))

(define-derived-unit SI '&pascal
  "Pa" "pressure" (g:/ &newton (g:square &meter)))

;;;; SI multipliers
...
(define-additional-unit SI '&lumen
  "lm" "luminous flux" (g:* &candela &steradian))

(define-additional-unit SI '&lux
  "lx" "illuminance" (g:/ &lumen (g:square &meter)))

(define-additional-unit SI '&katal
  "kat" "catalytic activity" (g:/ &mole &second))

(define-additional-unit SI '&becquerel
  "Bq" "activity" (g:/ &unitless &second))

(define-additional-unit SI '&gray
  "Gy" "absorbed dose" (g:/ &joule &kilogram))

(define-additional-unit SI '&sievert
  "Sv" "dose equivalent" (g:/ &joule &kilogram))


(define-additional-unit SI '&degree
  "$^\\circ$" "1/360 circle" &angular (g:/ :2pi 360))
...
(define-additional-unit SI '&arcsec
  "arcsec" "arc second" &radian (g:/ (g:* 2 :pi) (g:* 60 60 360)))
...
(define speed-of-light (& 2.99792458e8 (g:/ &meter &second)))

(define-additional-unit SI '&ly
  "ly" "Light Year"
  &meter
  (u:value (g:* speed-of-light &year)))

(define-additional-unit SI '&esu
  "esu" "Electrostatic Unit"
  &coulomb
  (u:value (g:/ 1 (g:* 10 speed-of-light))))
