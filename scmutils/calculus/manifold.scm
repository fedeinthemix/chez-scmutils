...
;;; FBE: we define this function in '(scmutils base).
...
;;; FBE: make parameter
(define *saved-environment-values* (make-parameter '()))
...
(define %calculus-manifold-dummy-1
  (begin
...
(define (S^2-coordinates orientation)
  (let ((orientation^-1 (invert orientation)))
	...
	(case m
      ...
      me)))

(define %calculus-manifold-dummy-2
  (begin
...
(define (S^n-coordinates orientation-function)
  ...
  (lambda (manifold)
	...
	(case m
      ...
      me)))

(define %calculus-manifold-dummy-3
  (begin
...
(define (S^n-stereographic orientation-function)
  (lambda (manifold)
	...
	(case m
      ...
      me)))

(define %calculus-manifold-dummy-4
  (begin
...
(define %calculus-manifold-dummy-5
...
(define alternate-chart
  (lambda (manifold)
    ...
    me))	   

(define %calculus-manifold-dummy-6
  (begin
...
(define %calculus-manifold-dummy-7
  (begin
