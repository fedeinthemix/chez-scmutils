...
(define *divide-out-terms* (make-parameter #f))
...
;;; FBE: make a parameter
(define *last-expression-printed* (make-parameter (lambda () 'none-yet)))

(define (system-environments)
  (list generic-environment ;rule-environment ; FBE: now alias for 'scmutils-base...'
