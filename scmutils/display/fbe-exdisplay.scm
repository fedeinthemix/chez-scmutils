...
;;; FBE: we may have to move this to the end of the file.
;; (module exdisplay-module (internal-show-expression
;;                           2d-show-expression
...
(define last-tex-string-generated (make-parameter (void)))
...
(define internal-show-expression
  (lambda (exp)
    (last-tex-string-generated (expression->tex-string exp))
...
(define display-tex-string display-in-screen-window)
