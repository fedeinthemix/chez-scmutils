...
;;; FBE: make parameters
(define brent-error (make-parameter 1.0e-5))

;;; f is a function of the parameters.

(define nelder-start-step (make-parameter .01))
(define nelder-epsilon (make-parameter 1.0e-10))
(define nelder-maxiter (make-parameter 1000))
