...
(define *ode-integration-method* (make-parameter 'BULIRSCH-STOER))
...
(define (set-ode-integration-method! method)
  (case method
    ((BULIRSCH-STOER bulirsch-stoer Bulirsch-Stoer)
     (*ode-integration-method* 'bulirsch-stoer))
    ((QCRK4 qcrk4)
     (*ode-integration-method* 'qcrk4))
    ((QCCTRAP2 qcctrap2)
     (*ode-integration-method* 'qcctrap2))
    ((QCCEULER qcceuler)
     (*ode-integration-method* 'qcceuler))
    ((Gear Explicit-Gear gear explicit-gear GEAR)
     ;; actually sysder here is f&df
     (*ode-integration-method* 'explicit-gear))
    (else
     (write-line
