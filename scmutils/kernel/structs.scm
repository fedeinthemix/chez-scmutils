...
(define (s->m ls ms rs)
  (if *careful-conversion*
      (assert (numerical-quantity? (g:* ls (g:* ms rs)))
              ...
              "Innapropriate s->m" (list ls ms rs)
              ))
    ...
    (let ((ms
      ...
      (if *careful-conversion*
          (assert (numerical-quantity? (g:* ls (g:* ms rs)))
                  ...
                  "Innapropriate m->s" (list ls ms rs)
                  ))
      ms)))
